...
public class TestResultCountDisplay extends Composite implements DisposeListener {
    ...
    private final Image errorIcon = LslPlusPlugin.createImage("icons/error.gif"); //$NON-NLS-1$
    private final Image failureIcon = LslPlusPlugin.createImage("icons/failed.gif"); //$NON-NLS-1$
