 ...
 *     Rob Greayer <robgreayer@yahoo.com>
 *          Copied and adapted for to use within the LSL Plus Plug-In 
 *          (original version part of the org.eclipse.ui.ide Plug-In)
 *******************************************************************************/
...
public class ContainerSelectionGroup extends Composite {
	...
	private static final String DEFAULT_MSG_NEW_ALLOWED = Messages.getString("ContainerSelectionGroup.ENTER_OR_SELECT"); //$NON-NLS-1$

	private static final String DEFAULT_MSG_SELECT_ONLY = Messages.getString("ContainerSelectionGroup.SELECT_THE_FOLDER"); //$NON-NLS-1$
