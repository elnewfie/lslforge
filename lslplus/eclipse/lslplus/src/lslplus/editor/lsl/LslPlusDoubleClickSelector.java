 ...
 *     Robert Greayer - modified minimally to work for LSL Plus instead of
 *                      Java 
 *******************************************************************************/
...
/**
 * Double click strategy aware of LslPlus identifier syntax rules.
 */
public class LslPlusDoubleClickSelector implements ITextDoubleClickStrategy {
	...
	/* 
	 * Create a LslPlusDoubleClickSelector.
	 */
	 public LslPlusDoubleClickSelector() {
		super();
	}
