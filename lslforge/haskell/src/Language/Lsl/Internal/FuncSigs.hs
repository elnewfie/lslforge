...
funcDescriptions = [    
    ...
    ("llGetAgentLanguage", (["scope","options"], "Requests a list of agents currently in the region, limited by the scope parameter. Returns a list [key id0, key id1, ..., key idn] or [string error_msg] - returns avatar keys for all agents in the region limited to the area(s) specified by scope.\n integer scope: AGENT_LIST_PARCEL, AGENT_LIST_PARCEL_OWNER, AGENT_LIST_REGION.\nlist options: Unused\n")),
    ("llGetAgentList", (["key"], "Returns a string that is the language code of the preferred interface language of the user avatar.\n")),
