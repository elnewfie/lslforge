...
funcDescriptions = [    
    ...
    ("llAttachToAvatarTemp",(["attach_point"],"Attaches the object to the avatar who has granted permission to the script. The same as llAttachToAvatar with exception: object will not create new inventory for the user, and will disappear on detach or disconnect.\n")),
    ...
    ("llTeleportAgentHome",(["avatar"],"Teleports agent on owner's land to agent's home location\n")),
