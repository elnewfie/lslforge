...
public class LSLForgeAdapterFactory implements IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, @SuppressWarnings("rawtypes") Class adapterType) {
		...
		} else if (adaptableObject instanceof LSLForgeScript && IResource.class.equals(adapterType)) {
		    return ((LSLForgeScript)adaptableObject).getResource();
		    
		} else if (adaptableObject instanceof LSLForgeScript && LSLForgeElement.class.equals(adapterType)) {
